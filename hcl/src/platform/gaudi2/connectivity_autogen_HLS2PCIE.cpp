...
static const Gen2ArchNicsDeviceSingleConfig g_HLS2PCIE_card_location_0_mapping = {
    ...
    std::make_tuple(NOT_CONNECTED_DEVICE_ID, 9, 3),   // NIC=9
    ...
    std::make_tuple(SCALEOUT_DEVICE_ID, 22, 0),  // NIC=22
    std::make_tuple(SCALEOUT_DEVICE_ID, 23, 1),  // NIC=23
};
...
static const Gen2ArchNicsDeviceSingleConfig g_HLS2PCIE_card_location_6_mapping = {
    ...
    std::make_tuple(4, 10, 0),                   // NIC=16
    std::make_tuple(4, 11, 1),                   // NIC=17
    std::make_tuple(4, 12, 2),                   // NIC=18
